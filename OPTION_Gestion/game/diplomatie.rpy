label relations:
    ...
    python:
        ...
        if num_random_ressource_1 == 0:
            random_ressource_1_requete = (100 + renpy.random.randint(0,100))*(1+0.1*(lvlbatimentadmin-1))
        elif num_random_ressource_1 == 1:
            random_ressource_1_requete = (25 + renpy.random.randint(0,50))*(1+0.1*(lvlbatimentadmin-1))
        elif num_random_ressource_1 == 2:
            random_ressource_1_requete = (2000 + renpy.random.randint(0,1000))*(1+0.1*(lvlbatimentadmin-1))
        elif num_random_ressource_1 == 3:
            random_ressource_1_requete = (4 + renpy.random.randint(0,4))*(1+0.1*(lvlbatimentadmin-1))

        if num_random_ressource_2 == 0:
            random_ressource_2_requete = (50 + renpy.random.randint(0,100))*(1-0.1*(lvlbatimentadmin-1))
        elif num_random_ressource_2 == 1:
            random_ressource_2_requete = (25 + renpy.random.randint(0,50))*(1-0.1*(lvlbatimentadmin-1))
        elif num_random_ressource_2 == 2:
            random_ressource_2_requete = (2000 + renpy.random.randint(0,1000))*(1-0.1*(lvlbatimentadmin-1))
        elif num_random_ressource_2 == 3:
            random_ressource_2_requete = (4 + renpy.random.randint(0,4))*(1-0.1*(lvlbatimentadmin-1))

    "Le chef [random_chef] vous propose un échange :"
    "[random_requete]"
    "Je vous donne [random_ressource_1_requete] [nom_random_ressource_1] contre [random_ressource_2_requete] [nom_random_ressource_2]"
    ...
    label menu_diplomatie :
        ...
        menu:
            "Oui" if val_random_ressource_2 >= random_ressource_2_requete:
                ...
                $ flag = False
                jump Interface
            "{color=#bbbbbb} Vous n'avez pas assez [nom_random_ressource_2_bis] {/color}" if val_random_ressource_2 < random_ressource_2_requete:
